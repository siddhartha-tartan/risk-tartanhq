  ...
  useEffect(() => {
    const verifyDocuments = async () => {
      try {
        ...
        // Fetch loan checklist data from the new API
        await fetchLoanChecklistData(documents);
        
        // Fetch AI insights from the new API
        await fetchAiInsights(documents);
      } catch (err: any) {
    ...
    // Set up event listener for the modal
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading && (
          <div className="flex justify-center items-center h-64">
            ...
            <span className="ml-3 text-indigo-500">Loading verification results...</span>
          </div>
        )}
